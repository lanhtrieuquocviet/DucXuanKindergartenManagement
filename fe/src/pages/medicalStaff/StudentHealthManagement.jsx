...
/** Đọc sheet import: cột 7 là Tình trạng (mới) hoặc Ghi chú (file cũ). */
        ...
        <DialogContent dividers>
          <Stack spacing={2}>
            <Alert severity="info" sx={{ fontSize: '0.8rem' }}>
              Dùng nút <strong>Tải mẫu</strong> để có sẵn họ tên và lớp; chỉ điền chiều cao, cân nặng, tiền sử, dị ứng, tình trạng (Bình thường / Theo dõi / Đáng lo ngại).<br />
