  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
      <div className="text-xs sm:text-sm text-gray-600 mb-4 sm:mb-6 flex flex-wrap items-center gap-1">
        ...
        Tin tức
        <span className="mx-1">›</span>
        <span className="font-medium text-gray-800">Hoạt động ngoại khóa</span>
      </div>

      <h1 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8">Hoạt động ngoại khóa</h1>
          ...
          {currentData.map((item) => (
            <div key={item.id} className="flex flex-col sm:flex-row gap-4 border-b pb-4 sm:pb-6">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs sm:text-sm text-gray-500">Hoạt động ngoại khóa | {item.date}</div>
              </div>
            </div>
          ))}
        </div>
